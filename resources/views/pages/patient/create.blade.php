                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" id="no_hp" placeholder="No. HP" value="{{ old('no_hp') }}">
                                @error('no_hp')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm">
                                <textarea type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" placeholder="Alamat" value="{{ old('alamat') }}">{{old('alamat')}}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
