        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('tambah.rujukan')}}" class="btn btn-danger btn-sm mb-1">
                        <i class="fas fa-plus"></i>
                        <span class="text">Tambah</span>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{route('rujukan')}}" method="GET">
                        <div class="row">
                            <div class="col-sm-4">
                            ...
                            <tbody>
                                @foreach ($datas as $key => $data)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="/surat/rujukan/{{Crypt::encrypt($data->id_referral_letters)}}/detail" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i></a>
                                            <a href="/surat/rujukan/{{Crypt::encrypt($data->id_referral_letters)}}/ubah" class="btn btn-sm btn-info"><i class="fa fa-pencil-alt"></i></a>
                                        </td>
                                    </tr>
