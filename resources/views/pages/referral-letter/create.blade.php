...
@section('title', 'Tambah Surat Rujukan')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form action="/surat/rujukan" method="POST">
                        @csrf
                            <div class="form-group row">
                                <label for="cari_pasien"  class="col-sm-3 col-form-label">Cari Pasien</label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('cari_pasien') is-invalid @enderror" name="cari_pasien" id="cari_pasien" placeholder="Cari NIK" value="{{ old('cari_pasien') }}" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="text" class="form-control @error('tujuan_dokter') is-invalid @enderror" name="tujuan_dokter" id="tujuan_dokter" placeholder="Nama Dokter" value="{{ old('tujuan_dokter') }}">
                                    @error('tujuan_dokter')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <input type="text" class="form-control @error('tujuan_lokasi') is-invalid @enderror" name="tujuan_lokasi" id="tujuan_lokasi" placeholder="Nama Lokasi" value="{{ old('tujuan_lokasi') }}">
                                    @error('tujuan_lokasi')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <textarea type="text" class="form-control @error('diagnosis_sementara') is-invalid @enderror" name="diagnosis_sementara" id="diagnosis_sementara" placeholder="Diagnosa Sementara">{{ old('diagnosis_sementara') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <textarea type="text" class="form-control @error('tindakan') is-invalid @enderror" name="tindakan" id="tindakan" placeholder="Tindakan Yang Telah Diberikan">{{ old('tindakan') }}</textarea>
                                    @error('tindakan')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm">
                                    <textarea type="text" class="form-control @error('catatan') is-invalid @enderror" name="catatan" id="catatan" placeholder="Catatan">{{ old('catatan') }}</textarea>
                                    @error('catatan')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
