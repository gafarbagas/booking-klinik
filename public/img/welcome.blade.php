                    ...
                    <div class="" style="min-width: 100%;min-height:70vh">
                        ...
                        <div class="card position-absolute" style="width: 60%; bottom: 0; right:0; border-radius: 20px">
                            <div class="card-body bg-danger" style="border-radius: 20px">
                                <img src="{{ asset('img/logo.png') }}" class="position-absolute"
                                    style="right: 0; top: 0">
                                <br><br>
                                <h4>Jam Buka</h4>
                                <p class="d-inline-block">Senin</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Selasa</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Rabu</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Kamis</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Jumat</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Sabtu</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                                <p class="d-inline-block">Minggu</p>
                                <p class="float-right"> 08.00 - 20.00 </p>
                                <hr class="my-3 float-right mr-3" width="40%" color="white">
                            </div>
                        </div>
